...
public class BoardController {
     ...
     */
    @PutMapping(value="")
    public ResponseEntity<String> updatePro(@RequestBody Board board) throws Exception {
        log.info("board : " + board);
        int result = new Random().nextInt(2);
    ...
    public ResponseEntity<String> deletePro(@PathVariable("boardNo") int boardNo) throws Exception {
